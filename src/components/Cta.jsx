      ...
      <div className=" overflow-hidden bg-[#DC6617] py-32 sm:py-32 rounded-3xl lg:h-[40rem] h-96 sm:h-full md:h-[40rem]">
        {/* <div className="hidden lg:block -z-10"> */}
          <img
            ...
            className="absolute right-0 mr-10 z-10  hidden lg:block"
          />
         <img
            src={bgImg2}
            alt="background Image"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 z-50">
          <div className="mx-auto lg:grid max-w-2xl grid-cols-1 gap-x-8   lg:mx-0 lg:max-w-none lg:grid-cols-2 ">
            <img
              ...
              className=" h-full w-auto lg:mt-7 md:mt-24 sm:-mb-32 "
            />

            {selectedLanguage === "English" && (
              <div className="hidden lg:block md:block  lg:pr-8 lg:pt-4 z-50">
            ...
            {selectedLanguage === "French" && (
              <div className="hidden lg:block md:block  lg:pr-8 lg:pt-4 mt-14 z-50">
                <div className="lg:max-w-lg">
                  <p className="mt-10  tracking-tight text-white text-6xl font-manrope">
                    C'est parti!
                  </p>
